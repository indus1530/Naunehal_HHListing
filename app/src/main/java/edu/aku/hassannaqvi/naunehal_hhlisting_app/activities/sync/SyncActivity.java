package edu.aku.hassannaqvi.naunehal_hhlisting_app.activities.sync;
...
import edu.aku.hassannaqvi.naunehal_hhlisting_app.CONSTANTS;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.R;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.adapters.SyncListAdapter;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.adapters.UploadListAdapter;
...
import edu.aku.hassannaqvi.naunehal_hhlisting_app.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.getClasses.GetAllData;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.otherClasses.SyncModel;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.syncClasses.SyncAllData;
import edu.aku.hassannaqvi.naunehal_hhlisting_app.syncClasses.SyncDevice;

import static edu.aku.hassannaqvi.naunehal_hhlisting_app.repository.UtilsKt.dbBackup;
